...
func TestDashboardNavigationAndPresentation(t *testing.T) {
	...
	if !strings.Contains(html, `href="/assets/app.css?v=20260911-pwa-install-copy"`) || !strings.Contains(html, `src="/assets/app.js?v=20260911-pwa-install-copy"`) {
	...
	if !strings.Contains(auth, `href="/assets/app.css?v=20260911-pwa-install-copy"`) {
